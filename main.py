...
def f4():
    ...
    while counter7:
        ...
        r4 = rect.Rect(600, 495, 55, 55)
        r5 = rect.Rect(900, 495, 55, 55)
        r6 = rect.Rect(1100, 470, 100, 4)
        r7 = rect.Rect(350, 554, 55, 76)
        r8 = rect.Rect(300, 390, 950, 4)
        r9 = rect.Rect(900, 70, 50, 4)
        r10 = rect.Rect(1050, 335, 55, 55)
        r11 = rect.Rect(750, 335, 55, 55)
        r12 = rect.Rect(450, 335, 55, 55)
        r13 = rect.Rect(300, 310, 100, 4)
        r14 = rect.Rect(300, 230, 950, 4)
        r15 = rect.Rect(500, 175, 55, 55)
        r16 = rect.Rect(700, 175, 55, 55)
        r17 = rect.Rect(875, 150, 100, 4)
        r18 = rect.Rect(1150, 554, 55, 76)
        r3_2 = rect.Rect(300, 554, 950, 4)
        r6_2 = rect.Rect(1100, 474, 100, 4)
        r8_2 = rect.Rect(300, 394, 950, 4)
        r9_2 = rect.Rect(900, 74, 50, 4)
        r13_2 = rect.Rect(300, 314, 100, 4)
        r14_2 = rect.Rect(300, 234, 950, 4)
        r17_2 = rect.Rect(875, 154, 100, 4)
...
def f5():
    ...
    while close_app == False:
        ...
        r4 = rect.Rect(430, 450, 60, 8)
        r5 = rect.Rect(560, 400, 200, 8)
        r6 = rect.Rect(650, 250, 50, 50)
        r7 = rect.Rect(800, 260, 400, 8)
        r8 = rect.Rect(660, 480, 30, 150)
        r9 = rect.Rect(850, 550, 200, 8)
        r10 = rect.Rect(950, 500, 50, 50)
        r11 = rect.Rect(1150, 450, 200, 8)
        r12 = rect.Rect(1350, 350, 50, 50)
        r13 = rect.Rect(1400, 430, 50, 200)
        r14 = rect.Rect(1550, 300, 50, 50)
        r15 = rect.Rect(1700, 350, 400, 8)
        r16 = rect.Rect(1575, 450, 50, 50)
        r17 = rect.Rect(1975, 430, 50, 200)
        r18 = rect.Rect(1700, 400, 50, 50)
        r19 = rect.Rect(2200, 350, 200, 8)
        r20 = rect.Rect(2350, 150, 50, 200)
        r21 = rect.Rect(2300, 580, 50, 50)
        r22 = rect.Rect(2800, 500, 50, 50)
        r23 = rect.Rect(2900, 400, 400, 8)
        r24 = rect.Rect(3300, 430, 50, 200)
        r25 = rect.Rect(3450, 430, 50, 50)
        r26 = rect.Rect(3450, 580, 200, 50)
        r27 = rect.Rect(3850, 530, 500, 8)
        r28 = rect.Rect(4300, 546, 50, 84)
        r29 = rect.Rect(4100, 480, 50, 50)
        r3_2 = rect.Rect(300, 558, 100, 8)
        r4_2 = rect.Rect(430, 458, 60, 8)
        r5_2 = rect.Rect(560, 408, 200, 8)
        r7_2 = rect.Rect(800, 268, 400, 8)
        r9_2 = rect.Rect(850, 558, 200, 8)
        r11_2 = rect.Rect(1150, 458, 200, 8)
        r15_2 = rect.Rect(1700, 358, 400, 8)
